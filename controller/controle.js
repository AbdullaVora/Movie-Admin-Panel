...
const admin = async (req, res) => {
  ...
  // try {
  //   const showPoster = await poster.find();
  //   res.render("admin",{showPoster});  
  // } catch (error) {
  //   console.log(error);
  // }
};
...
const updateData = async (req, res) => {
  try {
    ...
    let updateData = await movie.findByIdAndUpdate(req.body.id, {
      name: req.body.name,
      date: req.body.date,
      category: req.body.category,
      rating: req.body.rating,
